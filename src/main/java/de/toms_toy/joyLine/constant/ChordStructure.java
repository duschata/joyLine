...
public enum ChordStructure {
	...
	Minor6Arp("Minor6 Arp", "-6", _1, b3, _5, _6), @XmlEnumValue("Minor7Arp")
	Minor7Arp("Minor7 Arp", "-7", _1, b3, _5, _7), @XmlEnumValue("Minor7_5bArp")
	Minor7_5bArp("Minor7b5 Arp", "-7b5", _1, b3, b5, _7), @XmlEnumValue("Dominant7Arp")
	...
	Dominant7_b9Arp("Dominant7b9 Arp", " 7/b9 ", b9, _3, _5, _7), @XmlEnumValue("Dominant7_#5Arp")
	Dominant7_s5Arp("Dominant7#5 Arp", "7/#5", _1, _3, s5), @XmlEnumValue("Major7Arp")
	Major7Arp("Major7 Arp", " Δ ", _1, _3, _5, M7), @XmlEnumValue("Minor7Full")
	Minor7Full("Minor7 Full ", "-7", _1, b3, _5, _6, _7), @XmlEnumValue("Dominant7Full")
	Dominant7Full("Dominant7 Full", " 7 ", _1, _3, b5, _5, s5, _7, b9, _9, s9), @XmlEnumValue("Alt")
	Alt("Alt", "alt", _1, b9, s9, _3, b5, s5, _7), @XmlEnumValue("Major7Full")
